...
1.5 UK units\footnote{10ml, or 8g of pure alcohol.} per day) alcohol consumption. This ties to the current
...
reported significantly greater risk of both neonatal seizures (ca. three-fold) and epilepsy (1.81-fold) associated with binge drinking between
...
routine alcohol misuse screening as a part of all practice,
there is no specific policy for routine antenatal care beyond providing
information on possible impacts of alcohol consumption \citep{NationalInstituteforHealthandCareExcellence2010,NICE2010a}.
\ac{NICE} guidance on pregnancy and complex social factors \citep{NICE2010}
...
In summary then, there is a consensus that alcohol consumption is
...
stays, with higher satisfaction as found by \citet{Biro2003}.
