...
v(u_{w}) &= 10^{0.88} &= 7.59\\
w^{+}(p(l)p(r | l))  &= \frac{(p(l)p(r | l))^\gamma}{[(p(l)p(r | l))^\gamma + (1-(p(l)p(r | l)))^\gamma]^\frac{1}{\gamma}}\\
w^{+}(p(l)p(r | l))  &= \frac{\frac{1}{24}^{0.61}}{[\frac{1}{24}^{0.61} + (1-\frac{1}{24})^{0.61}]^\frac{1}{0.61}} &= 0.12\\
w^{+}(p(l)p(n | l)) &= \frac{\frac{1}{8}^{0.61}}{[\frac{1}{8}^{0.61} + (1-\frac{1}{8})^{0.61}]^\frac{1}{0.61}} &= 0.21\\
w^{+}(p(m)p(r | l)) &= 0.12
w^{+}(p(m)p(n | l)) &= 0.21
w^{+}(p(h)p(r | l)) &= 0.24
w^{+}(p(h)p(n | l)) &= 0.42
V(l) &= 0.12\cdot7.59 + 0.21\cdot7.59 + 0.12\cdot7.59 + 0.21\cdot7.59 + 0.24\cdot7.59 + 0.42\cdot7.59 &= 10.02
\end{align*}
\end{equation*}
