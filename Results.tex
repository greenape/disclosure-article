...
\begin{SCfigure}[H]
\begin{adjustbox}{center}\subfloat[Average fraction of population ever signalled honestly\label{fig:honest_signals}]{\includegraphics[width=78mm]{figures/honesty_plot}\end{adjustbox}{center}
}
\vskip
\begin{adjustbox}{center}\subfloat[Average fraction of population referred\label{fig:referrals}]{\includegraphics[width=78mm]{figures/ref_plot}}\end{adjustbox}
